...
export interface ReviewInput {
  ...
  /**
   * Derived PR intent (untrusted; delimiter-wrapped in the prompt, rendered
   * after `## PR description`). Empty/undefined → section omitted — this is
   * what keeps the no-intent path's assembled prompt byte-identical to
   * today's.
   */
  intent?: string;
